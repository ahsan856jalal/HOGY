...
lib = CDLL("/home/user/darknet_dir/libso.so", RTLD_GLOBAL)
...
"lunare",
"Other"]    
net = load_net("/home/user/darknet_dir/cfg/resnet50.cfg", "/home/user/darknet_dir/resnet50_weight.weights", 0)
meta = load_meta("/home/user/darknet_dir/cfg/datafile.data")
...
gmm_main_dir='/home/user/uwa/gmm_only'
gt_main_dir='/home/user/uwa/gt_dir'
save_main_dir='/home/user/uwa/save_dir'
saving_dir='/home/user/uwa/test_img'
...
for video_fol in gmm_fol:
    ...
    for gmm_files in gmm_text_files:
            img_gmm=cv2.imread(gmm_files.split('.txt')[0]+'.png') # gmm_optical image
            gmm_height=img_gmm.shape[0]
            gmm_width=img_gmm.shape[1]
            a=open(gmm_files)
            gmm_text=a.readlines()  # gmm_optical_text_file
            img_gt=cv2.imread(join(gt_main_dir,video_fol,gmm_files).split('.txt')[0]+'.png') # gt imagegmm_height=img_gmm.shape[0]
            img_rgb=np.copy(img_gt)
            gt_height=img_gt.shape[0]
            gt_width=img_gt.shape[1]
            ...
            for line_gt in gt_text:
                ...
                for line_gmm in gmm_text:
                    ...
                    if(ymax_gmm>gmm_height):
                        ymax_gmm=gmm_height
#                    cv2.rectangle(img_rgb, (xmin_gmm, ymin_gmm), (xmax_gmm, ymax_gmm), (127,96,85), 2)
...
#                                                
           ...
           f.write(xml_content)
           f.close()
           cv2.imwrite(join(save_main_dir,video_fol,gmm_files).split('.txt')[0]+'.png',img_rgb)
#            
